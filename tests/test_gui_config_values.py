...
class TestGuiConfigurationValues:
    ...
    def test_capture_emission_calculation_config(self, plugin_instance):
        ...
        assert em_config["should_apply_nox_corrections"] == False  # default is set to false/off
    ...
    def test_capture_output_modules_config(self, plugin_instance):
        ...
        for expected_module in expected_modules:
            assert expected_module in present_modules, f"Expected module '{expected_module}' not found in {present_modules}"
