...
def form_open(form, layer, feature):
    ...
    fields = dict(
        first_runway_number=form.findChild(QtWidgets.QComboBox,
                                           "first_runway_number"),
        first_runway_letter=form.findChild(QtWidgets.QComboBox,
                                           "first_runway_letter"),
        second_runway_number=form.findChild(QtWidgets.QComboBox,
                                            "second_runway_number"),
        second_runway_letter=form.findChild(QtWidgets.QComboBox,
                                            "second_runway_letter"),
    ...
    def on_save():
        form.changeAttribute("first_runway_number",
                             fields['first_runway_number'].currentText())
        form.changeAttribute("first_runway_letter",
                             fields['first_runway_letter'].currentText())
        form.changeAttribute("second_runway_number",
                             fields['second_runway_number'].currentText())
        form.changeAttribute("second_runway_letter",
                             fields['second_runway_letter'].currentText())
...
def first_runway_number_changed(fields: dict, *args, **kwargs):
    ...
    index = fields['second_runway_number'].findText(
        "%02d" % second_runway_number_value)
