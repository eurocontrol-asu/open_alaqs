...
def roadway_emission_factors(input_data: dict) -> dict:
    ...
    raise NotImplementedError('Support for COPERT 5 is still to be implemented.')
...
def get_emission_factors(copert_data, velocity, change_point):
    ...
    :param copert_data: list from the default_vehicle_XXX corresponding to a
     specific vehicle type
    :type copert_data: list
    :param velocity: the speed of the vehicle in km/h
    :type velocity: float
    :param change_point: the speed at which we switch from using A1 data to
     A2 data
