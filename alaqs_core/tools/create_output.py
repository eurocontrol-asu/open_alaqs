...
#     test_output_path = os.path.join("..", "example", "test_.alaqs")
#     test_movement_path = os.path.join("..", "example", "lfmn_movs.csv")
#
#     # Model parameters come from the calculate UI but for testing, we define them ourselves
