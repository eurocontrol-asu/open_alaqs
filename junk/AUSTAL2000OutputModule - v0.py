...
class AUSTAL2000DispersionModule(DispersionModule):
    ...
    def getGridXYFromReferencePoint(self):
        ...
        try:
            ...
            # logger.info("getGridXYFromReferencePoint: bottom left of the source grid: x0=%.0f, y0=%.0f" % (grid_origin_x, grid_origin_y))
            ...
            # logger.info("getGridXYFromReferencePoint: bottom left of the calc. grid: xq=%.0f, yq=%.0f" % (self._x_left_border_calc_grid, self._y_left_border_calc_grid))
    ...
    def process(self, startTimeSeries, endTimeSeries, timeval, result, ambient_conditions=None, **kwargs):
        ...
        # total_emissions_per_mov = sum([sum(emissions__) for (source_, emissions__) in result])
        ...
        for (source_, emissions__) in result:
            ...
            for emissions_ in emissions__:
                ...
                # isLine_element_ = bool("LINE" in emissions_.getGeometryText())
                ...
                # isPolygon_element_ = bool("POLYGON" in emissions_.getGeometryText())
