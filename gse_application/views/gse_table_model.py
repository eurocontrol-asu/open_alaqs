...
class GSETableModel(QAbstractTableModel):
    def __init__(self, gse_list):
        ...
        self._headers = ["type", "description", "power", "load", "fuel", "Stage", "time", "deterioration_factor"]
        self._valid_types = ["GPU", "PCA", "Baggage Tractor", "Pushback Tractor", "Catering Truck", "Fuel Truck", "Lavatory Truck", "Water Truck", "Cargo Loader", "Belt Loader", "Passenger Stairs", "Other", "GSE"]
        self._valid_stages = ["Stage I", "Stage II", "Stage IIIA", "Stage IIIB", "Stage IV", "Stage V"]
    ...
    def setData(self, index, value, role=Qt.EditRole):
        ...
        try:
            ...
            QMessageBox.warning(None, "Invalid Input", f"Invalid value for {attr}: {value}")
            return False
    ...
    def _validate_input(self, attr, value):
        ...
        try:
            ...
            QMessageBox.warning(None, "Invalid Input", 
                f"Invalid numeric value for {attr}: {value}")
            return False
