...
if __name__ == "__main__":
    ...
    aircraft_to_engine_number = pd.read_excel(src_path / c.FILE_EMISSIONS, c.TAB_AIRCRAFT_TO_ENGINE)
    ...
    aircraft_mtow = pd.read_excel(src_path / c.FILE_MTOW_INFORMATION, converters={"mtow": int})[["icao", "mtow"]]
